...
function MapTooltip({
    ...
    return (
        <LeafletTooltip
            className={cn(
                "animate-in fade-in-0 zoom-in-95 fade-out-0 zoom-out-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 w-fit border border-border! bg-popover! px-2 py-1.5 text-xs text-balance text-popover-foreground! shadow-md backdrop-blur-sm transition-opacity",
                className
            )}
            data-side={side}
            direction={side}
            ...
            <div
                className={cn(
                    "absolute z-50 size-2.5 rotate-45 rounded-[2px] border-r border-b border-border bg-popover",
